      ...
      {data.map((id) => (
        <div className="w-full lg:w-1/3 px-2" key={id}>
          ...
          >
            ...
            />
            <figcaption className="absolute top-0 left-0 rtl:right-0 w-full h-full p-3">
              <h5 className="absolute bottom-0 left-0 rtl:right-0 p-3 w-1/2 text-right rtl:text-left text-xl font-bolder text-white transition duration-150 ease-in-out transform translate-x-full">
                Gallery {id}
              </h5>
            </figcaption>
          </figure>
